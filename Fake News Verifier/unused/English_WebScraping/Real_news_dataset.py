...
for article in articles:
    ...
    if (
        ...
        data.append({"title": title, "text": text, "label": "Real"})  # Modify label accordingly

# Convert to DataFrame
df = pd.DataFrame(data)

# Define the desired file path
csv_filename = r"C:\Users\vigne\Documents\fake_news_verifier\Fake News Verifier\English_WebScraping\Real_filtered_news_dataset.csv"
